"""Problem 19.2 — what Part III's instruction count says the call cannot beat.
...
from tests.ch21.harness import ask

# (instructions, ipc_x100, mhz)
CASES = {
    "ch08's path at IPC 1.5": (83, 150, 2_400),
    "ch08's path at IPC 1.0": (83, 100, 2_400),
    "ch08's path at IPC 0.5": (83, 50, 2_400),
    "ch08's path on a slower clock": (83, 250, 1_500),
...
def test_halving_the_ipc_doubles_the_floor():
    ...
    fast = expected(*CASES["ch08's path at IPC 1.5"])
    slow = expected(*CASES["ch08's path at IPC 0.5"])
