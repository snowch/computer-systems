...
from tests.prerequisites_and_setup.problem_1_trust import can_you_publish_this_timing
...
def test_publishable(description: str, payload: dict, expected: bool):
    try:
        ...
        pytest.fail(
            "Problem 0.1 is not solved yet — see tests/prerequisites_and_setup/problem_1_trust.py"
        )
