"""Problem 3 of chapter 1 — take the folding away.
...
There is more than one way to do it, and they are not equally good. Chapter 1 explains what the
...
unsigned long reader_sum(unsigned long span) {
  /* Problem 1.3 — see the Problems section of chapter 1.
   *
