"""Problem 3 of the privilege chapter — find another refusal.
...
#: The cause code it produces. The privilege chapter's table has the one you are not allowed to reuse.
ITS_CAUSE: int = 0
