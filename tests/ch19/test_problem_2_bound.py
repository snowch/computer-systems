"""Problem 19.2 — what Part II's instruction count says the call cannot beat.
...
CASES = {
    "ch06's path at IPC 1.5": (83, 150, 2_400),
    "ch06's path at IPC 1.0": (83, 100, 2_400),
    "ch06's path at IPC 0.5": (83, 50, 2_400),
    "ch06's path on a slower clock": (83, 250, 1_500),
...
def test_halving_the_ipc_doubles_the_floor():
    ...
    fast = expected(*CASES["ch06's path at IPC 1.5"])
    slow = expected(*CASES["ch06's path at IPC 0.5"])
