"""Problem 2 of the whole-program chapter — predict what a source change disturbs.
...
`python3 -m pytest tests/what_a_computer_does_with_a_program/test_problem_2_ripple.py`, which does not compare your answer with
...
def stages_disturbed_by(change: str) -> set[str]:
    ...
    raise NotImplementedError(
        "Problem 1.2 — see the Problems section of the whole-program chapter."
    )
