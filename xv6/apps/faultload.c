 ...
 *
 * ch15 compares xv6's two allocation policies, which this kernel already offers: `sbrk` allocates
 ...
 * ch13 paid for — so every quantity below is a constant this program decided, and it prints them
