...
| | |
|---|---|
| **Chapters** | [ch21](#ch21)–[ch28](#ch28) |
| **Target** | `host` — Linux on real hardware, natively ([hardware](#ch00)) |
| **Assumes** | [Part IV](#part4), and a machine of your own that meets [ch00](#ch00)'s requirements |
:::
...
[ch21](#ch21) comes first and is the method: how to get a number you would defend, and how you
...
[ch21](#ch21), and this is the one instruction in the book worth being rigid about. Every chapter
