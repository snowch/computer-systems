...
| | |
|---|---|
| **Chapters** | [ch13](#ch13)–[ch20](#ch20) |
| **Target** | `xv6` — the teaching kernel under QEMU, with [ch20](#ch20) crossing to `host` |
...
of [ch04](#ch04)'s handler. It is a different subject, and it is this one.
...
rather than designs; the chapters say which, and [ch26](#ch26) puts the same operations to a
...
[ch13](#ch13), in order. Each chapter names the one before it as its prerequisite and means it.

[ch20](#ch20) is the exception and can be read early if you want to know where the book is going.
