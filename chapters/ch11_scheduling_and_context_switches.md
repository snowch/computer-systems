---
title: "Scheduling and Context Switches [DRAFT]"
short_title: "ch11 Scheduling and Context Switches"
---

(ch11)=
# ch11 · Scheduling and Context Switches [DRAFT]
...
[To write: each problem is a stub under `tests/ch11/` with a test that passes only when
