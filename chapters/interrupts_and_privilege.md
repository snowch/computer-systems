...
| **Prerequisites** | [ch06](#a-trap-with-nothing-else) |
...
[ch29](#the-os-layers-cost) asks that question on hardware.
...
[ch08](#one-page-table-two-harts) adds the other thing that arrives without being asked for, which
