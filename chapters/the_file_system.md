...
short_title: "22 · The File System"
---
...
| **Prerequisites** | [ch21](#scheduling-and-context-switches) |
...
`bench/run_blocks.py` refuses to stamp a result where that no longer holds. Problem 22.1 is that
...
than to a processor, and shares nothing with [ch20](#locks-and-memory-ordering)'s fences but a name.
...
**22.1 — How many block writes does a transaction cost?**
