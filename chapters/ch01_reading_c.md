...
puzzle for its own sake: `int (*f)(void)` is how every device driver in [ch16](#ch16) is reached,
...
into a parameter's brackets, and [ch10](#ch10) has the bug it causes.
...
Which offsets, and why they are not simply the sum of the sizes before them, is [ch10](#ch10)'s
...
**What any of this costs.** No chapter in this part has a clock in it. [ch22](#ch22) is where
...
[ch10](#ch10) takes it apart.

**Whether your pointer is valid.** C has no answer to this and neither does the hardware, until
[ch15](#ch15). A pointer is an index; nothing checks that the index means anything.
