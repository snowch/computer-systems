...
| | |
|---|---|
| **Chapters** | [ch10](#what-a-computer-does-with-a-program)–[ch13](#linking-and-loading) |
| **Target** | `xv6`, with [ch10](#what-a-computer-does-with-a-program) crossing to `host` and saying which figure came from where |
...
is [ch24](#optimising-code), and it is in [Part V](#part5) because the answer is about cost.
...
[ch10](#what-a-computer-does-with-a-program), in order. This part is a single argument in four steps and each chapter finishes a
...
If you already know ELF and want the rest, [ch11](#representing-information) stands alone reasonably well; it is about
...
[ch10](#what-a-computer-does-with-a-program) compiles the same source on both targets, because the claim it makes — that the
