...
| | |
|---|---|
| **Chapters** | [ch11](#what-a-computer-does-with-a-program)–[ch14](#linking-and-loading) |
| **Target** | `xv6`, with [ch11](#what-a-computer-does-with-a-program) crossing to `host` and saying which figure came from where |
...
who finishes it. [ch14](#linking-and-loading) ends at `exec`, which is precisely where [Part IV](#part4) begins.
...
is [ch25](#optimising-code), and it is in [Part V](#part5) because the answer is about cost.
...
[ch11](#what-a-computer-does-with-a-program), in order. This part is a single argument in four steps and each chapter finishes a
...
If you already know ELF and want the rest, [ch12](#representing-information) stands alone reasonably well; it is about
...
[ch11](#what-a-computer-does-with-a-program) compiles the same source on both targets, because the claim it makes — that the
