---
title: "Whole-Machine Profiling [DRAFT]"
short_title: "ch20 Whole-Machine Profiling"
---

(ch20)=
# ch20 · Whole-Machine Profiling [DRAFT]
...
[To write: each problem is a stub under `tests/ch20/` with a test that passes only when
