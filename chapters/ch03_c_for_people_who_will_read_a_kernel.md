---
title: "C for People Who Will Read a Kernel [DRAFT]"
short_title: "ch03 C for People Who Will Read a Kernel"
---

(ch03)=
# ch03 · C for People Who Will Read a Kernel [DRAFT]
...
[To write: each problem is a stub under `tests/ch03/` with a test that passes only when
