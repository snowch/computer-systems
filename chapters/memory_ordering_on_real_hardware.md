...
short_title: "28 · Memory Ordering on Real Hardware"
---

(memory-ordering-on-real-hardware)=
# 28 · Memory Ordering on Real Hardware
...
[ch20](#locks-and-memory-ordering) printed what a release looks like on both architectures, and the two are not alike.
...
[ch24](#measuring) asked for a distribution instead of a number. This chapter asks for something else
first: a **prediction**.
...
[ch30](#whole-machine-profiling)'s equipment.
...
that relies on not seeing it is broken on a chip that does. [ch20](#locks-and-memory-ordering)'s problem 20.2 is about
...
**28.1 — Which fields will two cores fight over?**
...
**28.2 — What does the curve look like before you measure it?**
...
**28.3 — Same requirement, two architectures.**
...
[ch29](#the-os-layers-cost) returns to [Part IV](#part4) with the same equipment. Everything xv6 demonstrated structurally
