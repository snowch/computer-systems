...
short_title: "29 · Whole-Machine Profiling"
---

(whole-machine-profiling)=
# 29 · Whole-Machine Profiling
...
| **Prerequisites** | [ch28](#the-os-layers-cost) |
...
counted in lines, and there are no unvisited lines. This is [ch27](#memory-ordering-on-real-hardware)'s observation about coherence reappearing as
...
in the source of that function, and [ch26](#the-cpu) already established what a branch this lopsided
costs a predictor.
...
[ch18](#interrupts-and-drivers)'s mechanism, in hardware you have already met, doing a job that has nothing to do
...
— problem 29.2 is how many samples a claim needs before it is worth making, and the answer is
...
and cannot change. Problem 29.1 is putting the callers back together, and the reason it matters is
...
does not visit every position — it visits the multiples of a number that problem 29.3 asks you to
...
enough to collect samples. For anything shorter, the equipment is [ch23](#measuring)'s — repetition and
...
**29.2 — How many samples is a claim?**
...
[ch30](#vectors) is the last measurement in the book and the narrowest: one loop, one unit, and the
