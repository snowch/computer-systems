---
title: "Machine-Level Code on RISC-V [DRAFT]"
short_title: "ch04 Machine-Level Code on RISC-V"
---

(ch04)=
# ch04 · Machine-Level Code on RISC-V [DRAFT]
...
[To write: each problem is a stub under `tests/ch04/` with a test that passes only when
