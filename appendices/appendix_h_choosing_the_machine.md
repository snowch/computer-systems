...
Every figure in [Part V](#part5) was measured on the machine this table describes. It is a
statement about one piece of silicon and not about a product line, which is the whole reason it is
printed rather than quoted from a datasheet.

```{include} ../chapters/_generated/appendix-h-board.md
```
