...
Keep this open from [ch13](#ch13) onwards. The rows are grouped by chapter because that is how you
...
name, which is that [ch13](#ch13) explains why the shell is the worst possible thing to measure.
...
on purpose. `fs.c` does a great deal that [ch19](#ch19) never mentions.
