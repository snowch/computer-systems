...
|---|---|---|
| The board has not reported | `appendix-h-board` figure, `bench/figures.py` | `bench/results/setup-host.json` does not exist yet. Run `make bench-board` on the reference machine, commit the result, and remove the `pending=` marker. |
