/* The program chapter 20 hands the reader without explaining it.
 *
 * Copyright 2026 Chris Snow. Apache-2.0 — see LICENSE-CODE.
 *
 * Everything measured up to here has been code this book wrote, in a loop chosen to isolate one
 * mechanism, with the answer already known. That is the wrong shape for the skill ch27 is about,
