/* The book's clock, and the honesty about it that the measurement chapter is for.
 *
 ...
 * single duration is not a measurement, it is an anecdote, and the whole of the measurement chapter is about what to
 * report instead.
 *
 ...
 * about the work. The measurement chapter says when that reasoning fails. */
