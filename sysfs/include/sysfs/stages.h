 ...
 *
 * The whole-program chapter follows a program from source text to a result and asks which of that journey costs
 ...
 * The whole-program chapter reads both listings side by side.
 *
